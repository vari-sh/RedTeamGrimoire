...
DWORD CalcFrameSize(PVOID pFunc) {
    ...
    fnRtlLookupFunctionEntry RtlLookup = (fnRtlLookupFunctionEntry)CustomGetProcAddress(hK32, "RtlLookupFunctionEntry");
...
BOOL InitEngine() {
    ...
    Mask_Security.pAddress = SeekReturnAddress(CustomGetProcAddress(hK32, "VirtualProtectEx"));
    Mask_Worker.pAddress   = SeekReturnAddress(CustomGetProcAddress(hK32, "CreateProcessW"));
    Mask_Memory.pAddress   = SeekReturnAddress(CustomGetProcAddress(hK32, "MapViewOfFile"));
    Mask_File.pAddress     = SeekReturnAddress(CustomGetProcAddress(hK32, "MoveFileW"));
    ...
    qThreadBase = SeekReturnAddress((PVOID)((ULONG_PTR)CustomGetProcAddress(hK32, "BaseThreadInitThunk")));
    qRtlUserThreadStart = SeekReturnAddress((PVOID)((ULONG_PTR)CustomGetProcAddress(ntdllBase, "RtlUserThreadStart")));
