...
const char *g_HellHallAsm =
    ...
    "        ; The kernel will never reach this high up the stack to clobber it.\n"
    "        mov [rsp + 8h], rsi\n"
    "        mov [rsp + 10h], rdi\n"
    "\n"
    "        ; 2. ALLOCATE THE PERFECT FRAME\n"
    "        ; Allocate exactly (qFrameSize - 8) below the original return address.\n"
    "        xor rax, rax\n"
    "        mov eax, qFrameSize\n"
    "        sub rax, 8\n"
    "        sub rsp, rax\n"
    ...
    "        ; Safe to do because we enforce a minFrameSize of 0x100 in the C builder.\n"
    "        mov rcx, 8\n"
    "        cld\n"
    "        rep movsq\n"
    "\n"
    ...
    "        push qGadgetAddress  ; RSP drops by 8, finalizing the perfect frame size\n"
    ...
    "        \n"
    "        ; Revert the spoofed frame allocation\n"
    "        xor rax, rax\n"
    "        mov eax, qFrameSize\n"
    "        sub rax, 8\n"
    "        add rsp, rax\n"
