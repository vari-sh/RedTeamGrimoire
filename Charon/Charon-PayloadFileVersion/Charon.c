 ...
 *      6. External UUID Staging: Decouples the payload from the main artifact by 
 *         loading an external, UUID-encoded file. This bypasses static analysis 
 *         of the executable while maintaining low entropy in the staged data.
 *
 * Author: vari.sh
 * ======================================================================================
 */
...
const char *g_StubTemplate =
    ...
    "    \n"
    "    if(totalSize < 0x100) totalSize = 0x100; \n"
    "    \n"
    "    return totalSize;\n"
    "}\n"
    "\n"
